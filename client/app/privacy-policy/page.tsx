    ...
    <>
      ...
      <main className="min-h-screen bg-white text-black">
        <div className="mx-auto max-w-4xl px-6 py-16 sm:px-8 lg:px-10 lg:py-20">
          ...
          <section className="space-y-3">
            <h2 className="text-2xl font-medium text-black">4. Legal Basis for Processing (GDPR)</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-2xl font-medium text-black">5. Data Sharing & Transfers</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-2xl font-medium text-black">6. Data Retention</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-2xl font-medium text-black">7. Your Rights</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-2xl font-medium text-black">8. Cookies & Tracking Technologies</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-2xl font-medium text-black">9. Data Security</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-2xl font-medium text-black">10. Children&apos;s Privacy</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-2xl font-medium text-black">11. Changes to This Policy</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-2xl font-medium text-black">12. Contact</h2>
