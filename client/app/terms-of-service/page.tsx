    ...
    <>
      ...
      <main className="min-h-screen bg-white text-black">
        <div className="mx-auto max-w-4xl px-6 py-16 sm:px-8 lg:px-10 lg:py-20">
          ...
          <section className="space-y-3">
            <h2 className="text-2xl font-medium text-black">2. Eligibility</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-2xl font-medium text-black">3. Scope of Services</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-2xl font-medium text-black">4. User Responsibilities</h2>
            <p>You agree to:</p>
          ...
          <section className="space-y-3">
            <h2 className="text-2xl font-medium text-black">5. Fees and Payments</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-2xl font-medium text-black">6. Intellectual Property</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-2xl font-medium text-black">7. Data Protection & Privacy</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-2xl font-medium text-black">8. Third-Party Services</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-2xl font-medium text-black">9. Limitation of Liability</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-2xl font-medium text-black">10. Indemnification</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-2xl font-medium text-black">11. Termination</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-2xl font-medium text-black">12. Governing Law & Jurisdiction</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-2xl font-medium text-black">13. Changes to Terms</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-2xl font-medium text-black">14. Contact</h2>
