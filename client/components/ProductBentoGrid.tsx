      ...
      <BentoGrid className="grid-cols-1 sm:grid-cols-2 auto-rows-auto gap-3">
        ...
        <div className="relative">
          ...
          <div
            ...
            className="pointer-events-none absolute left-[42%] top-8 h-2.5 w-2.5 -translate-x-1/2 rounded-full bg-[#E543FF]/85 shadow-[0_0_10px_rgba(229,67,255,0.38)] sm:left-5 sm:top-[42%] sm:-translate-x-0 sm:-translate-y-1/2"
          />
          <div
            ref={rightBottomAnchorRef}
            className="pointer-events-none absolute left-[58%] top-8 h-2.5 w-2.5 -translate-x-1/2 rounded-full bg-[#FF8CDF]/85 shadow-[0_0_10px_rgba(255,140,223,0.38)] sm:left-5 sm:top-[58%] sm:-translate-x-0 sm:-translate-y-1/2"
          />
        </div>
      </BentoGrid>
