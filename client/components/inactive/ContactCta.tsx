...
function RadarLogoVisual() {
  const rings = [42, 72, 102, 132, 162, 192];

  return (
    <div
      className="relative flex h-97.5 w-full max-w-135 items-center justify-center overflow-hidden"
      aria-hidden="true"
    >
      <svg className="absolute inset-0 h-full w-full" viewBox="0 0 520 390" fill="none">
        <defs>
          <radialGradient
            ...
            gradientTransform="translate(260 195) rotate(90) scale(132 188)"
          >
            <stop stopColor={purple} stopOpacity="0.24" />
            <stop offset="1" stopColor={purple} stopOpacity="0" />
          </radialGradient>
        </defs>
        <rect width="520" height="390" fill="url(#radar-glow)" />
        {rings.map((radius, i) => (
          <motion.circle
            key={radius}
            cx="260"
      ...
      >
        <Image
          ...
          width={86}
          height={86}
          className="h-24 w-24 drop-shadow-[0_0_34px_rgba(229,67,255,0.34)]"
          priority={false}
        />
      </motion.div>
    </div>
      ...
      <div className="mx-auto max-w-[1400px] px-6 py-12 sm:px-8 sm:py-14 lg:px-10 lg:py-16">
        <div className="lg:grid lg:grid-cols-2 lg:items-center lg:gap-16">
          ...
          <div className="max-w-2xl">
            ...
            <motion.h2
              className="text-[2.2rem] font-medium leading-[1.08] tracking-tight text-[#f0f0f0] sm:text-5xl sm:leading-[1.1]"
              ...
              <form className="mt-6 flex flex-col gap-3" onSubmit={(e) => e.preventDefault()}>
                ...
                <button
                  ...
                  style={{
                    ...
                    background: "linear-gradient(180deg, rgba(229,67,255,0.22) 0%, rgba(180,30,230,0.16) 100%)",
                  }}
                >
                  Book a Meeting
                  <IconArrowRight
